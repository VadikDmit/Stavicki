                ...
                {questions.map((q, i) => (
                    <div
                        ...
                        style={{
                            ...
                            height: '4px',
                            borderRadius: '2px',
                            background: answers[q.id] !== undefined ? 'var(--theme-primary)' : 'rgba(255,255,255,0.1)',
                            cursor: 'pointer',
                                ...
                                return (
                                    <button
                                        ...
                                        style={{
                                            padding: '14px 16px',
                                            borderRadius: '12px',
                                            border: `2px solid ${isSelected ? 'var(--theme-primary)' : 'var(--border-color)'}`,
                                            background: isSelected ? 'rgba(193, 229, 107, 0.18)' : 'var(--card-bg)',
                                            color: 'var(--text-main)',
                                            textAlign: 'left',
                                            cursor: 'pointer',
                                            fontSize: '14px',
