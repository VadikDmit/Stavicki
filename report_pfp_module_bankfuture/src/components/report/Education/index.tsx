...
const EducationReportComponent = ({ number, target }: GoalReportType) => (
    <TargetGoalReport number={number} target={target} title='Образование детей' coverImgSrc={coverImg.src} />
);

export default EducationReportComponent;
