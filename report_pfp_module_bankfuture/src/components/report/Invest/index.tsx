...
const InvestReportComponent = ({ number, target }: GoalReportType) => {
    ...
    return (
        <ReportLayout title='Инвестиции' number={`${number}`} isTarget months={target.months} riskScoreTotal={riskScoreTotal}>
...
export default InvestReportComponent;
