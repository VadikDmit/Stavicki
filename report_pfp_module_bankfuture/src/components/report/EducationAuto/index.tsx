...
const EducationAutoReportComponent = ({ number, target }: GoalReportType) => (
    <TargetGoalReport number={number} target={target} title='Образование + Авто' coverImgSrc={coverImg.src} />
);

export default EducationAutoReportComponent;
