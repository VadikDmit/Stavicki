...
const OtherTravelReportComponent = ({ number, target }: GoalReportType) => (
    <TargetGoalReport number={number} target={target} title='Путешествие' coverImgSrc={coverImg.src} />
);

export default OtherTravelReportComponent;
