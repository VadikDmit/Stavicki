...
const MortgageCashReportComponent = ({ number, target }: GoalReportType) => {
    ...
    return (
        <ReportLayout title='Ипотечный кредит' number={`${number}`} isTarget>
...
export default MortgageCashReportComponent;
